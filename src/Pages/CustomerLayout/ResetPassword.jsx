    ...
    if (password !== confirmPassword) {
      ...
      try {
        ...
        if (response.status === 200) {
          console.log("success");
          navigate('/userlogin')
          toast("Your password have been updated")
        ...
        <div className="d-flex align-items-center justify-content-center mt-3">
          <div className="border-1 col-4 p-3 mb-5 mt-3">
            ...
            <div className="">
              ...
              <h4 className="text-center">Remember Password ? <span style={{color:"#EE7B7B"}}><Link to="/userLogin"> Go back</Link></span> </h4>
                <button type="submit" className="button1 color-2 mt-4 w-100">Reset Password</button>
              </form>
            </div>
          </div>
        </div>
