...
useEffect(()=>{
  ...
  useEffect(() => {
    ...
    shopPageQuery();
  }, [page, categoryParam, subCategoryParams])
        ...
        <div className="themesflat-container container-md">
          <div className="row ">
                ...
                <div>
                  <div className="sidebar sidebar-shop innerfixed">
                    ...
                    <div className="widget widget_category style-2 wow fadeInUp">
                      ...
                      <h5 className="widget-title mt-1 mb-3" onClick={() => { setCategoryParam("all"); setSubCategoryParams("all"); setPage(1); navigate("/shop") }}>All</h5>
                        {sideBarResponse?.map((ele,i)=>{
                        return <div className="dropdown mt-2 mb-3">
                          <h2 className="d-flex justify-content-between align-items-center" style={{ cursor: "pointer" }} onClick={() => { setIndexValue(i); setBoolean(!boolean); setCategoryParam(ele.category_name); navigate("/shop") }}> {ele.category_name}<span><FontAwesomeIcon icon={faChevronDown} /> </span></h2>
                            <div className={`showWithTransition px-4 ${ indexValue == i ?' open ':''}` } >
                                {ele.subcategories?.map((e)=>{
                                  return <p className="dropdown-item fw-lighter pt-2" type="button" onClick={() => { setSubCategoryParams(e.subcategory_name); setPage(1); navigate("/shop") }}>{e.subcategory_name}</p>
                                })}
                            </div>
                        </div>
                        }) }
            ...
            <div className="col-lg-9 col-md-8">
              ...
              <div className="themesflat-pagination style-2 text-left clearfix d-flex justify-content-end">
                <ul>
                  {/* <li>
